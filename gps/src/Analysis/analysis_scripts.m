...
occluded_walking_x_values = occluded_walking_x_values- occluded_walking_msgs{1}.UTMEasting;
occluded_walking_y_values = occluded_walking_y_values - occluded_walking_msgs{1}.UTMNorthing;
figure ('Name','occluded walking UTMNorthing vs UTMEasting');
scatter(occluded_walking_x_values, occluded_walking_y_values, '.');
xlabel('UTMEasting occluded walking (meters)');
ylabel('UTMNorthing occluded walking (meters)');
