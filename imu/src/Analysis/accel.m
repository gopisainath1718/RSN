...
xlabel('time in sec')
ylabel(' accel X in m/s^2')
title('stationary data time series plot for accel X')
grid on

subplot(2,2,2);
plot(timestamp,accel_y);
xlabel('time in sec')
ylabel(' accel Y in m/s^2')
title('stationary data time series plot for accel y')
grid on

subplot(2,2,3);
plot(timestamp,accel_z);
xlabel('time in sec')
ylabel(' accel Z in m/s^2')
title('stationary data time series plot for accel z')
grid on
