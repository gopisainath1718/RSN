...
accel_x = accel_x(700:841)    %this is for video snippet of 25 to 30 seconds 
accel_y = accel_y(700:841)    % considered only the part for which we took video snippets
accel_z = accel_z(700:841) 
timestamp = timestamp(700:841)
figure(1);
subplot(2,2,1);
